...
function dcc_slider(; kwargs...)
        available_props = Symbol[:id, :marks, :value, :className, :disabled, :dots, :included, :min, :max, :tooltip, :step, :vertical, :updatemode, :loading_state, :persistence, :persisted_props, :persistence_type]
        wild_props = Symbol[]
